...
@implementation BABLabeledSliderCell {
	...
	-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)identifier specifier:(PSSpecifier *)specifier {
        ...
        //Create value label
			...
			_valueLabel.text = [NSString stringWithFormat:@"%.0f", [[specifier performGetter] floatValue]];
    ...
    UISlider *slider = (UISlider *)self.control;
		NSString *currentValue = [NSString stringWithFormat:@"%.0f", slider.value];
